...
-- sub evaluator to fix substraction problem
-- indeed, I have to fix the program as the synthaxic tree for expression is
-- not created correctly (the last add operation of the string should be parsed
-- first).
evalExpr' :: Expr -> Double
evalExpr' (Sub el er) = (evalExpr el) + (evalExpr' er)
